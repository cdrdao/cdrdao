...
Gf8_Q_Coeffs_Results_01::Gf8_Q_Coeffs_Results_01()
{
    ...
    for (j = 0; j < 45; j++) {
        GF8_Q_COEFFS[0][j] =
            gf8_add(GF8_COEFFS_HELP[0][j], gf8_div(GF8_COEFFS_HELP[1][j], GF8_ILOG[1]));
    }
...
{
    u_int32_t crc = calc_edc(sector + LEC_DATA_OFFSET, LEC_MODE2_FORM1_DATA_LEN);
...
{
    u_int32_t crc = calc_edc(sector + LEC_DATA_OFFSET, LEC_MODE2_FORM2_DATA_LEN);
...
void lec_encode_mode1_sector(u_int32_t adr, u_int8_t *sector)
{
    ...
    sector[LEC_MODE1_INTERMEDIATE_OFFSET] = sector[LEC_MODE1_INTERMEDIATE_OFFSET + 1] =
        sector[LEC_MODE1_INTERMEDIATE_OFFSET + 2] = sector[LEC_MODE1_INTERMEDIATE_OFFSET + 3] =
            sector[LEC_MODE1_INTERMEDIATE_OFFSET + 4] = sector[LEC_MODE1_INTERMEDIATE_OFFSET + 5] =
...
void lec_encode_mode2_form1_sector(u_int32_t adr, u_int8_t *sector)
{
    ...
    sector[LEC_HEADER_OFFSET] = sector[LEC_HEADER_OFFSET + 1] = sector[LEC_HEADER_OFFSET + 2] =
