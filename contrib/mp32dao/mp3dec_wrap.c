 ...
 * Version 1.3u-20001117-2159 (Alpha 3)
 * 
...
/* $Header: /home/denis/sandbox/cvs/cdrdao_migration/cdrdao/cdrdao/contrib/mp32dao/Attic/mp3dec_wrap.c,v 1.1 2001/02/17 23:24:54 andreasm Exp $ */
...
#define SWIG_init    boot_mp3dec

#define SWIG_name   "mp3dec::boot_mp3dec"
#define SWIG_varinit "mp3dec::var_mp3dec_init();"
#ifdef __cplusplus
extern "C"
#endif
#ifndef PERL_OBJECT
...
#endif
extern int decode_mp3(char *,char *);
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_mp3dec_var::
class _wrap_mp3dec_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_perl5_mp3dec_var_init) {
    dXSARGS;
    SV *sv;
    cv = cv; items = items;
    XSRETURN(1);
...
XS(SWIG_init) {
	 ...
	 char *file = __FILE__;
	 cv = cv; items = items;
	 newXS("mp3dec::var_mp3dec_init", _wrap_perl5_mp3dec_var_init, file);
	 newXS("mp3dec::decode_mp3", _wrap_decode_mp3, file);
{
   int i;
