...
class PQChannelEncoder
{
  public:
    ...
    // sheet in bytes
    int setCueSheet(SubChannel *, unsigned char discType, const unsigned char *, int len,
  ...
  private:
    ...
    CueSheetEntry *nextCueSheetEntry(CueSheetEntry *act, int trackNr, int indexNr);
};
