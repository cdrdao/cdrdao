...
void SubChannel::encodeCatalogNumber(unsigned char *buf, char n1, char n2, char n3, char n4,
                                     char n5, char n6, char n7, char n8, char n9, char n10,
...
void SubChannel::decodeCatalogNumber(const unsigned char *in, char *n1, char *n2, char *n3,
                                     char *n4, char *n5, char *n6, char *n7, char *n8, char *n9,
                                     char *n10, char *n11, char *n12, char *n13)
{
    *n1 = ((in[0] >> 4) & 0x0f) + '0';
    *n2 = (in[0] & 0x0f) + '0';
    *n3 = ((in[1] >> 4) & 0x0f) + '0';
...
void SubChannel::encodeIsrcCode(unsigned char *buf, char c1, char c2, char o1, char o2, char o3,
                                char y1, char y2, char s1, char s2, char s3, char s4, char s5)
{
    unsigned char d;
...
void SubChannel::decodeIsrcCode(const unsigned char *in, char *c1, char *c2, char *o1, char *o2,
                                char *o3, char *y1, char *y2, char *s1, char *s2, char *s3,
                                char *s4, char *s5)
{
    unsigned char d;
