...
class CdrDriver
{
  public:
    ...
    virtual int writeData(TrackData::Mode, TrackData::SubChannelMode sm, long &lba, const char *buf,
                          long len);
    ...
    enum WriteCdProgressType {
        WCD_LEADIN = PGSMSG_WCD_LEADIN,
        WCD_DATA = PGSMSG_WCD_DATA,
        WCD_LEADOUT = PGSMSG_WCD_LEADOUT
    };
    int sendWriteCdProgressMsg(WriteCdProgressType type, int totalTracks, int track,
                               int trackProgress, int totalProgress, int bufferFillRate,
                               int writeBufferFill = 0);
    ...
    static const char *selectDriver(int readWrite, const char *vendor, const char *model,
  ...
  protected:
    ...
    virtual int sendCmd(const unsigned char *cmd, int cmdLen, const unsigned char *dataOut,
    ...
    virtual int writeZeros(TrackData::Mode, TrackData::SubChannelMode, long &lba, long encLba,
                           long count);
    ...
    virtual int analyzeTrack(TrackData::Mode, int trackNr, long startLba, long endLba, Msf *index,
                             int *indexCnt, long *pregap, char *isrcCode, unsigned char *ctl) = 0;
    ...
    // if possible.
    int analyzeTrackSearch(TrackData::Mode, int trackNr, long startLba, long endLba, Msf *index,
    ...
    virtual int getTrackIndex(long lba, int *trackNr, int *indexNr, unsigned char *ctl);
    ...
    int analyzeTrackScan(TrackData::Mode, int trackNr, long startLba, long endLba, Msf *index,
                         int *indexCnt, long *pregap, char *isrcCode, unsigned char *ctl);
    ...
    virtual int readSubChannels(TrackData::SubChannelMode, long lba, long len, SubChannel ***,
                                Sample *buf) = 0;
    ...
    virtual int analyzeDataTrack(TrackData::Mode mode, int trackNr, long startLba, long endLba,
                                 long *pregap);
    ...
    virtual long readTrackData(TrackData::Mode, TrackData::SubChannelMode, long lba, long len,
                               unsigned char *buf) = 0;

    // Reads a complete data track and saves data to a file.
    virtual int readDataTrack(ReadDiskInfo *, int fp, long start, long end, TrackInfo *trackInfo);
    ...
    // actual driver.
    virtual int readAudioRange(ReadDiskInfo *, int fp, long start, long end, int startTrack,
                               int endTrack, TrackInfo *) = 0;

    virtual int readAudioRangeStream(ReadDiskInfo *, int fd, long start, long end, int startTrack,
    ...
    enum ReadCdProgressType {
        RCD_ANALYZING = PGSMSG_RCD_ANALYZING,
        RCD_EXTRACTING = PGSMSG_RCD_EXTRACTING
    };
    void sendReadCdProgressMsg(ReadCdProgressType, int totalTracks, int track, int trackProgress,
                               int totalProgress);
  ...
  public:
    ...
    // C linkage :)
    long audioRead(TrackData::SubChannelMode, int byteOrder, Sample *buffer, long startLba,
                   long len);
  ...
  protected:
    ...
    int readAudioRangeParanoia(ReadDiskInfo *, int fp, long start, long end, int startTrack,
                               int endTrack, TrackInfo *trackInfo);
