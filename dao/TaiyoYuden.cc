...
int TaiyoYuden::startDao()
{
    ...
    // write lead-in
    if (writeZeros(toc_->leadInMode(), TrackData::SUBCHAN_NONE, lba, 0, leadInLength_) != 0) {
        flushCache();
        return 1;
    }
...
// return: 0: OK
//         1: scsi command failed
int TaiyoYuden::writeData(TrackData::Mode mode, TrackData::SubChannelMode sm, long &lba,
