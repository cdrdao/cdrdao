#ifndef SG_ERR_H
#define SG_ERR_H
#include <scsi/scsi.h> /* cope with silly includes */
...
extern const char *sg_strcmdopts(const unsigned char *command);
extern void sg_print_sense(const char *leadin, const unsigned char *sense_buffer);
...
extern int sg_chk_n_print(const char *leadin, int target_status, int host_status, int driver_status,
...
extern int sg_err_category(int target_status, int host_status, int driver_status,
                           const unsigned char *sense_buffer);
