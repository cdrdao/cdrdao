...
// return: 0: OK
//         1: scsi command failed
int CDD2600Base::modeSelectSpeed(int readSpeed, int writeSpeed, int simulate, int showMessage)
{
    unsigned char mp[8];
...
// return: 0: OK
//         1: scsi command failed
int CDD2600Base::readSessionInfo(long *leadInLen, long *leadOutLen, int showMessage)
{
    ...
    *leadOutLen = (data[2] << 8) | data[3];
    ...
    log_message(4, "Lead-in length: %ld, lead-out length: %ld", *leadInLen, *leadOutLen);
